...
import image1 from "../../Assets/Store/iPhone1.jpg";
import image2 from "../../Assets/Store/iPhone2.jpg";
import image3 from "../../Assets/Store/iPhone3.jpg";
import image4 from "../../Assets/Store/iPhone4.jpg";
       ...
       <div className='hidden lg:block mt-9'>
        <section className='max-w-7xl mx-auto grid grid-cols-2 gap-10 px-2'>   
            ...
            <div className='mt-20 flex gap-3 flex-col'>
                    <h1 className='font-bold text-3xl break-all w-80'>Apple iPhone 11 Pro Max 64/256/512GB</h1>
