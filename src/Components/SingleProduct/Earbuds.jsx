...
import image1 from "../../Assets/Store/earpod1.jpg";
import image2 from "../../Assets/Store/earpod2.jpg";
import image3 from "../../Assets/Store/earpod3.jpg";
import image4 from "../../Assets/Store/earpod4.jpg";
    ...
    <>
            <div className='flex flex-col items-center justify-center my-12 md:flex md:flex-row md:gap-5 lg:hidden'>
                ...
                <div className='mt-20 flex sm:justify-center gap-3 flex-col px-2'>
                    <h1 className='font-bold text-3xl break-all'>Bluetooth Earbuds TWS 5.3</h1>
                    ...
                    <p className='line-through'>$22.99</p>
       ...
       <div className='hidden lg:block mt-9'>
        <section className='max-w-7xl mx-auto grid grid-cols-2 gap-10 px-2'>   
            ...
            <div className='mt-20 flex gap-3 flex-col'>
                    <h1 className='font-bold text-3xl break-all w-80'>Bluetooth Earbuds TWS 5.3</h1>
