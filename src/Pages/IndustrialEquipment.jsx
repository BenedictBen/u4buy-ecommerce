...
import banner from "../Assets/HomeGarden/banner.webp";
import { BsHeart } from "react-icons/bs";
import { industrial } from "../Components/IndustrialEquipment/IndustrialEquipmentData";
    ...
    <div className='mt-9'>
      <div className=' hidden lg:block relative'>
          <div className='absolute top-7 left-16'>
            <h1 className=' font-bold text-3xl text-black'>Business & Industrial</h1>
            <p className='font-lighter text-xl text-black'>The place for business solutions since 1995</p>
          </div>
          <div className=''>
