...
import banner from "../Assets/Electronics/banner.webp";
import { electronics } from '../Components/Electronics/ElectronicData';
      ...
      <div>
        <div className=' hidden lg:block relative'>
          <div className='absolute top-7 left-16'>
            <h1 className='text-white font-bold text-3xl'>Electronics</h1>
            <p className='text-white font-lighter text-xl'>The place for smart(er) upgrades since 1995</p>
          </div>
          <div className=''>
