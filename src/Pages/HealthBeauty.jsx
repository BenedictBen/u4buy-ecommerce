...
import banner from "../Assets/Health&Beauty/banner.webp";
import { BsHeart } from "react-icons/bs";
import { healthbeauty } from "../Components/HealthBeauty/healthbeautyData"
    ...
    <div className='mt-9'>
      <div className=' hidden lg:block relative'>
          <div className='absolute top-7 left-16'>
            <h1 className='text-black font-bold text-3xl text[#003147]'></h1>
            <p className='text-black font-lighter text-xl text[#003147]'></p>
          </div>
          <div className=''>
