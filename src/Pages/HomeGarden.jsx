...
import { home } from "../Components/HomeGarden/HomeGardenData";
    ...
    <div className='mt-9'>
      <div className=' hidden lg:block relative'>
          <div className='absolute top-7 left-16'>
            <h1 className=' font-bold text-3xl text-black'>Garden & Garden</h1>
            <p className='font-lighter text-xl text-black'>The place to spruce up your space since 1995</p>
          </div>
          <div className=''>
        ...
        <div className='mt-9'>
          <div className='block px-8 mb-2 lg:hidden'>
            <h1 className='font-bold text-lg underline'>Home & Garden</h1>
          </div>
